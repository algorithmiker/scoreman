...
//        input: impl ParserInput<'a>, out: &mut Out, _settings: Self::BackendSettings,
//    ) -> BackendResult<'a> {
//        let mut diagnostics = vec![Diagnostic::warn(NoLocation, DiagnosticKind::Muxml1IsBad)];
//        let parser = Parser2 { track_measures: true, track_sections: false };
//
...
//        diagnostics.push(Diagnostic::info(NoLocation, DiagnosticKind::Muxml1SeperateTracks));
